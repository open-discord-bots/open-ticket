...
import { ODPdfTranscriptData, ODTranscriptCompiler, ODTranscriptCompilerCompileResult, ODTranscriptHistoryData } from "../api/transcript.js"
...
export interface ODFileManagerIdMappings extends api.ODFileManagerIdConstraint {
    ...
    "opendiscord:pdf-transcript":{origin:"channel"|"creator-dm"|"participant-dm"|"active-admin-dm"|"every-admin-dm"|"other",params:{guild:discord.Guild,channel:discord.GuildTextBasedChannel,user:discord.User,ticket:ODTicket,compiler:ODTranscriptCompiler<any,object|null>,result:ODTranscriptCompilerCompileResult<any>},workers:"opendiscord:pdf-transcript"}
}
...
export interface ODEmbedManagerIdMappings extends api.ODEmbedManagerIdConstraint {
    ...
    "opendiscord:transcript-pdf-ready":{origin:"channel"|"creator-dm"|"participant-dm"|"active-admin-dm"|"every-admin-dm"|"other",params:{guild:discord.Guild,channel:discord.GuildTextBasedChannel,user:discord.User,ticket:ODTicket,compiler:ODTranscriptCompiler<ODPdfTranscriptData,null>,result:ODTranscriptCompilerCompileResult<ODPdfTranscriptData>},workers:"opendiscord:transcript-pdf-ready"},
