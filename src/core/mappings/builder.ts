...
export interface ODEmbedManagerIdMappings extends api.ODEmbedManagerIdConstraint {
    ...
    "opendiscord:transcript-pdf-ready":{origin:"channel"|"creator-dm"|"participant-dm"|"active-admin-dm"|"every-admin-dm"|"other",params:{guild:discord.Guild,channel:discord.GuildTextBasedChannel,user:discord.User,ticket:ODTicket,compiler:ODTranscriptCompiler<{buffer:Buffer,fileName:string,warnings:string[]},null>,result:ODTranscriptCompilerCompileResult<{buffer:Buffer,fileName:string,warnings:string[]}>},workers:"opendiscord:transcript-pdf-ready"},
