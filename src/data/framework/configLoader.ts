...
export const defaultTranscriptsFormatter = new fjs.TopLevelCommentFormatter(new fjs.MultiCommentFormatter([
    ...
    new fjs.ObjectFormatter("pdfTranscriptStyle",true,[
        new fjs.MultiCommentFormatter([
            "Configure local PDF transcripts. HTML remains the default transcript mode unless general.mode is changed.",
            "Attachment metadata is included when PDF transcripts are enabled.",
            "Image previews and forwarded archive attachments only download Discord CDN attachment URLs and respect the limits below."
        ].join("\n")),
        new fjs.PropertyFormatter("enabled"),
        new fjs.PropertyFormatter("includeEmbeds"),
        new fjs.PropertyFormatter("includeStickers"),
        new fjs.ObjectFormatter("branding",true,[
            new fjs.PropertyFormatter("enabled"),
            new fjs.PropertyFormatter("title"),
            new fjs.PropertyFormatter("subtitle"),
            new fjs.PropertyFormatter("logoUrl"),
            new fjs.PropertyFormatter("logoPath"),
            new fjs.PropertyFormatter("showServerIcon"),
            new fjs.PropertyFormatter("showBotBranding"),
            new fjs.PropertyFormatter("footerText"),
            new fjs.PropertyFormatter("watermarkText"),
            new fjs.PropertyFormatter("showWatermark"),
        ]),
        new fjs.ObjectFormatter("colors",true,[
            new fjs.PropertyFormatter("primary"),
            new fjs.PropertyFormatter("secondary"),
            new fjs.PropertyFormatter("background"),
            new fjs.PropertyFormatter("surface"),
            new fjs.PropertyFormatter("headerBackground"),
            new fjs.PropertyFormatter("headerText"),
            new fjs.PropertyFormatter("text"),
            new fjs.PropertyFormatter("mutedText"),
            new fjs.PropertyFormatter("border"),
            new fjs.PropertyFormatter("accent"),
            new fjs.PropertyFormatter("success"),
            new fjs.PropertyFormatter("warning"),
            new fjs.PropertyFormatter("danger"),
            new fjs.PropertyFormatter("attachmentBackground"),
            new fjs.PropertyFormatter("attachmentBorder"),
        ]),
        new fjs.ObjectFormatter("layout",true,[
            new fjs.PropertyFormatter("pageSize",new fjs.SingleCommentFormatter("Choices: A4, Letter")),
            new fjs.ObjectFormatter("margins",true,[
                new fjs.PropertyFormatter("top"),
                new fjs.PropertyFormatter("bottom"),
                new fjs.PropertyFormatter("left"),
                new fjs.PropertyFormatter("right"),
            ]),
            new fjs.PropertyFormatter("fontSize"),
            new fjs.PropertyFormatter("messageSpacing"),
            new fjs.PropertyFormatter("compactMode"),
            new fjs.PropertyFormatter("showPageNumbers"),
            new fjs.PropertyFormatter("showTimestamps"),
            new fjs.PropertyFormatter("showUserIds"),
            new fjs.PropertyFormatter("showMessageIds"),
        ]),
        new fjs.ObjectFormatter("attachments",true,[
            new fjs.PropertyFormatter("includeAttachmentMetadata"),
            ...
            new fjs.PropertyFormatter("sendArchiveFilesSeparately"),
            new fjs.PropertyFormatter("archiveExtensions"),
            new fjs.PropertyFormatter("archiveContentTypes"),
            new fjs.PropertyFormatter("maxSeparateFileSizeMB"),
            new fjs.PropertyFormatter("maxTotalSeparateFilesSizeMB"),
            new fjs.PropertyFormatter("fallbackToAttachmentLinks"),
        ]),
    ]),
]))
