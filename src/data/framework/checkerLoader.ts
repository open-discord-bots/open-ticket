...
export const defaultGeneralStructure = new api.ODCheckerObjectStructure("opendiscord:general",{children:[
    ...
    {key:"system",checker:new api.ODCheckerObjectStructure("opendiscord:system",{children:[
        ...
        {key:"panelButtonRowLength",checker:new api.ODCheckerNumberStructure("opendiscord:panel-button-row-length",{zeroAllowed:false,negativeAllowed:false,floatAllowed:false,min:1,max:5,cliInitDefaultValue:5,cliDisplayName:"Panel Button Row Length",cliDisplayDescription:"Max buttons per row in panels. Also caps total buttons per panel. (Discord max 5)"})},
